  ...
  return (
    <>
      ...
      <style>{`
        ...
        .period-btn--active { background: var(--primary-light,#ebf8ff); color: var(--primary,#3182ce); }
        ...
        .chip--active { background: var(--primary-light,#ebf8ff); color: var(--primary,#3182ce); border-color: var(--primary,#3182ce); font-weight: 500; }
